...
site [mineinabyss.com](https://mineinabyss.com) for news and our social media links. See also,
this [plugin's docs](https://docs.mineinabyss.com/MineInAbyss).
...
- [Idofront platform](https://github.com/MineInAbyss/Idofront/releases/latest)
...
- `gradlew build` compiles plugin jar
- `gradlew docsServe` previews documentation locally